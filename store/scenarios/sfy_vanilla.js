...
sfy_vanilla.elems = [
	...
	{	cat:'inventory',	group:'sfy_machines',	subgroup:'machines_1',	type:'item',	id:'water_pump',	name:'sfy_water_pump',	desc:'sfy_water_pump_desc',	max:5,	img:'/fgfactory/icons/water_pump.png',		build:{ result:1, seconds:0.25, costs:{ 'copper_sheet':20, 'iron_plate_2':10, 'rotor':10 } },	reqs:{ 'order_2':1 },	},
	...
	{	cat:'storages',	group:'box_1',	subgroup:'box_1_8',	type:'storage',	id:'box_1_iron_plate_3',	name:'sfy_iron_plate_3',	img:'/fgfactory/icons/iron_plate_3.png',	assign:{ id:'box_1', storage:{ id:'iron_plate_3', count:50 } },	reqs:{ 'order_1':1 },	},

	{	cat:'storages',	group:'box_1',	subgroup:'box_1_7',	type:'storage',	id:'box_1_modular_frame',	name:'sfy_modular_frame',	img:'/fgfactory/icons/modular_frame.png',	assign:{ id:'box_1', storage:{ id:'modular_frame', count:100 } },	reqs:{ 'order_2':1 },	},
	{	cat:'storages',	group:'box_1',	subgroup:'box_1_7',	type:'storage',	id:'box_1_iron_plate_2',	name:'sfy_iron_plate_2',	img:'/fgfactory/icons/iron_plate_2.png',	assign:{ id:'box_1', storage:{ id:'iron_plate_2', count:100 } },	reqs:{ 'hub_upgrade_5':1 },	},
	{	cat:'storages',	group:'box_1',	subgroup:'box_1_7',	type:'storage',	id:'box_1_rotor',	name:'sfy_rotor',	img:'/fgfactory/icons/rotor.png',	assign:{ id:'box_1', storage:{ id:'rotor', count:100 } },	reqs:{ 'order_1':1 },	},
	
	{	cat:'storages',	group:'box_1',	subgroup:'box_1_6',	type:'storage',	id:'box_1_concrete',	name:'sfy_concrete',	img:'/fgfactory/icons/concrete.png',	assign:{ id:'box_1', storage:{ id:'concrete', count:500 } },	reqs:{ 'hub_upgrade_5':1 },	},

	{	cat:'storages',	group:'box_1',	subgroup:'box_1_5',	type:'storage',	id:'box_1_cable',	name:'sfy_cable',	img:'/fgfactory/icons/cable.png',	assign:{ id:'box_1', storage:{ id:'cable', count:200 } },	reqs:{ 'hub_upgrade_5':1 },	},
	{	cat:'storages',	group:'box_1',	subgroup:'box_1_5',	type:'storage',	id:'box_1_wire',	name:'sfy_wire',	img:'/fgfactory/icons/wire.png',	assign:{ id:'box_1', storage:{ id:'wire', count:500 } },	reqs:{ 'hub_upgrade_5':1 },	},
	{	cat:'storages',	group:'box_1',	subgroup:'box_1_5',	type:'storage',	id:'box_1_copper_sheet',	name:'sfy_copper_sheet',	img:'/fgfactory/icons/copper_sheet.png',	assign:{ id:'box_1', storage:{ id:'copper_sheet', count:100 } },	reqs:{ 'order_2':1 },	},

	{	cat:'storages',	group:'box_1',	subgroup:'box_1_4',	type:'storage',	id:'box_1_iron_plate',	name:'sfy_iron_plate',	img:'/fgfactory/icons/iron_plate.png',	assign:{ id:'box_1', storage:{ id:'iron_plate', count:200 } },	reqs:{ 'hub_upgrade_5':1 },	},
	{	cat:'storages',	group:'box_1',	subgroup:'box_1_4',	type:'storage',	id:'box_1_screw',	name:'sfy_screw',	img:'/fgfactory/icons/screw.png',	assign:{ id:'box_1', storage:{ id:'screw', count:500 } },	reqs:{ 'hub_upgrade_5':1 },	},
	{	cat:'storages',	group:'box_1',	subgroup:'box_1_4',	type:'storage',	id:'box_1_iron_rod',	name:'sfy_iron_rod',	img:'/fgfactory/icons/iron_rod.png',	assign:{ id:'box_1', storage:{ id:'iron_rod', count:200 } },	reqs:{ 'hub_upgrade_5':1 },	},
	...
	{	cat:'storages',	group:'box',	subgroup:'box_8',	type:'storage',	id:'box_iron_plate_3',	name:'sfy_iron_plate_3',	img:'/fgfactory/icons/iron_plate_3.png',	assign:{ id:'box', storage:{ id:'iron_plate_3', count:25 } },	reqs:{ 'order_1':1 },	},

	{	cat:'storages',	group:'box',	subgroup:'box_7',	type:'storage',	id:'box_modular_frame',	name:'sfy_modular_frame',	img:'/fgfactory/icons/modular_frame.png',	assign:{ id:'box', storage:{ id:'modular_frame', count:50 } },	reqs:{ 'order_2':1 },	},
	{	cat:'storages',	group:'box',	subgroup:'box_7',	type:'storage',	id:'box_iron_plate_2',	name:'sfy_iron_plate_2',	img:'/fgfactory/icons/iron_plate_2.png',	assign:{ id:'box', storage:{ id:'iron_plate_2', count:50 } },	reqs:{ 'hub_upgrade_3':1 },	},
	{	cat:'storages',	group:'box',	subgroup:'box_7',	type:'storage',	id:'box_rotor',	name:'sfy_rotor',	img:'/fgfactory/icons/rotor.png',	assign:{ id:'box', storage:{ id:'rotor', count:50 } },	reqs:{ 'order_1':1 },	},

	{	cat:'storages',	group:'box',	subgroup:'box_6',	type:'storage',	id:'box_concrete',	name:'sfy_concrete',	img:'/fgfactory/icons/concrete.png',	assign:{ id:'box', storage:{ id:'concrete', count:250 } },	reqs:{ 'hub_upgrade_3':1 },	},

	{	cat:'storages',	group:'box',	subgroup:'box_5',	type:'storage',	id:'box_cable',	name:'sfy_cable',	img:'/fgfactory/icons/cable.png',	assign:{ id:'box', storage:{ id:'cable', count:100 } },	reqs:{ 'hub_upgrade_3':1 },	},
	{	cat:'storages',	group:'box',	subgroup:'box_5',	type:'storage',	id:'box_wire',	name:'sfy_wire',	img:'/fgfactory/icons/wire.png',	assign:{ id:'box', storage:{ id:'wire', count:250 } },	reqs:{ 'hub_upgrade_2':1 },	},
	{	cat:'storages',	group:'box',	subgroup:'box_5',	type:'storage',	id:'box_copper_sheet',	name:'sfy_copper_sheet',	img:'/fgfactory/icons/copper_sheet.png',	assign:{ id:'box', storage:{ id:'copper_sheet', count:50 } },	reqs:{ 'order_2':1 },	},

	{	cat:'storages',	group:'box',	subgroup:'box_4',	type:'storage',	id:'box_iron_plate',	name:'sfy_iron_plate',	img:'/fgfactory/icons/iron_plate.png',	assign:{ id:'box', storage:{ id:'iron_plate', count:100 } },	reqs:{ 'hub_upgrade_1':1 },	},
	{	cat:'storages',	group:'box',	subgroup:'box_4',	type:'storage',	id:'box_screw',	name:'sfy_screw',	img:'/fgfactory/icons/screw.png',	assign:{ id:'box', storage:{ id:'screw', count:250 } },	reqs:{ 'hub_upgrade_3':1 },	},
	{	cat:'storages',	group:'box',	subgroup:'box_4',	type:'storage',	id:'box_iron_rod',	name:'sfy_iron_rod',	img:'/fgfactory/icons/iron_rod.png',	assign:{ id:'box', storage:{ id:'iron_rod', count:100 } },	reqs:{ 'hub_upgrade_1':1 },	},
