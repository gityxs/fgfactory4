<script setup>
	...
	const storageElem = computed(() => gameStore.getElem(elem.value.assign.storage.id))
...
<template>
	...
	<div class="row gx-2 align-items-center">
				...
				<div class="row g-3">
					...
					<div v-if="inputs" class="col-12">
						<div class="row g-1">
							...
							<div class="col-auto"><span class="opacity-50 small text-uppercase fw-bold">{{ $t('word_inputs') }}</span></div>
					...
					<div v-if="outputs" class="col-12">
						<div class="row g-1">
							...
							<div class="col-auto"><span class="opacity-50 small text-uppercase fw-bold">{{ $t('word_outputs') }}</span></div>
		...
		<div class="col-auto"><value-max :elem="storageElem" /></div>
